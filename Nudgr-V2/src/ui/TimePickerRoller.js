...
export default function TimePickerRoller({
  ...
  return (
    <View style={styles.container}>
      ...
      {/* Quick Relative Test Buttons (+1 min, +2 min, +5 min) */}
      <View style={styles.relativeRow}>
        <Text style={styles.relativeLabel}>Quick Test Presets:</Text>
        <TouchableOpacity style={styles.relativeBtn} onPress={() => setFromNow(1)}>
          <Text style={styles.relativeBtnText}>+1 min</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.relativeBtn} onPress={() => setFromNow(2)}>
          <Text style={styles.relativeBtnText}>+2 min</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.relativeBtn} onPress={() => setFromNow(5)}>
          <Text style={styles.relativeBtnText}>+5 min</Text>
        </TouchableOpacity>
      </View>
